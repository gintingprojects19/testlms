...
sbnm.addEventListener("click",function(){
    if(pilihpengguna.value=="guru" && nmkamu.value!=="" && pskamu.value=="1"){
    ...
    if(pilihpengguna.value=="guru" && nmkamu.value=="" && pskamu.value!=="1"){
        blurscreen.style.display="block";
        textkonfir.textContent="Nama belum diisi dan password salah";
        textkonfir.style.color="black";
        textkonfir.style.backgroundColor="white";
        konfirmasilog.style.display="block";
        konlms.style.display="none";
    ...
    if(pilihpengguna.value=="siswa" && nmkamu.value!=="" && pskamu.value=="2"){
    ...
    if(pilihpengguna.value=="siswa" && nmkamu.value!=="" && pskamu.value!=="2"){
        blurscreen.style.display="block";
        textkonfir.textContent="Password salah / belum diisi";
        textkonfir.style.color="black";
        textkonfir.style.backgroundColor="white";
        konfirmasilog.style.display="block";
        konfirmasilog.style.backgroundColor="white";
